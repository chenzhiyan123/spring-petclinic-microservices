...
import org.springframework.samples.analysis.BusinessCodeAnalysis;
...
public class BusinessCodeRequestRCA extends BusinessCodeRCA {
    ...
    public void doRCA(InputFault inputFault, FaultRepository faultRepository, FaultEdgeRepository faultEdgeRepository, ExecutorService executorService) {
        ...
        if (fault.isEmpty()) {
            BusinessCodeAnalysis faultAnalysis = new BusinessCodeAnalysis();
            Fault rootFault = faultAnalysis.localize(inputFault);
